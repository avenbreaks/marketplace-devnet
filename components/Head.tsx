...
export const Head: FC<Props> = ({
  ogImage = 'https://s3-storage.glitshock.ai/glit-bg.svg',
  title = 'Glitshock-AI | Multi-Chain NFT Explorer',
  description = 'Glitshock-AI Multi-Chain NFT Explorer is an open source NFT explorer built with Glitshock-AI.',
  metatags = null,
}) => {
  return (
    <NextHead>
