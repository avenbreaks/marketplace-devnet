...
const developerSectionLinks = [
  {
    name: 'Docs',
    href: 'https://docs.glitshock.ai',
  },
  {
    name: 'Github',
    href: 'https://github.com/gitshock-labs',
  }
]
...
const companySectionLinks = [
  {
    name: 'Jobs',
    href: 'https://glitshock-ai.com/careers',
  },
  {
    name: 'DEX Terminal',
    href: 'https://dexscreener.com/base/contracts',
  }
]
...
export const Footer = () => {
  return (
    ...
    >
      ...
      >
        <SectionTitle title="Join Glitshock-AI Community" />
        <Flex css={{ gap: '$4', mt: 16 }}>
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://twitter.com/Glitshock-AI"
          >
